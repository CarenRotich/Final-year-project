          ...
          {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                us at supportElitemarketplace.com with your order number and a
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                supportElitemarketplace.com, or by calling us at +254700289488
                between the hours of 9am and 10pm EAT, Monday through Friday.
              </p>
            </div>
          )}
        </div>
          ...
          {activeTab === 7 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                cash on delivery system. Soon implementing M-Pesa payment.
              </p>
            </div>
          )}
        </div>
